    ...
    <header>
        ...
        <nav class="top-menu">
            ...
            <div id="home" class="hide">
            	<a class="xl-link" href="home"><p class="menu men Ho">Home</p></a>
            </div>
            <div id="cours" class="hide">
                <a class="xl-link" href="cours"><p class="menu men Co">Cours</p></a>
            </div>
            <div id="clicker" class="hide">
                <a class="xl-link" href="clicker"><p class="menu men Cl">Clicker</p></a>
            </div>
        </nav>
